                ...
                <div className="flex mx-4 md:flex-col items-center h-16 md:py-0 md:h-full w-full justify-between ">
                    ...
                    <div className="hidden md:flex flex-col justify-between items-center md:h-1/3">
                        ...
                        {sideNavbarLinks.map(link => (
                            <NavLinks key={link.key} href={link.href} Icon={link.Icon} title={link.name} />
                        ))}
                    ...
                    <div className="hidden md:flex flex-col justify-center">
                        ...
                        {userDetailsFromLocalStorage && (
                            <img className="w-10 h-10 cursor-pointer rounded-full" src={userDetailsFromLocalStorage.userImage}
                                onClick={() => {
                ...
                >
                    <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                        ...
                        <div className="py-6 px-5 space-y-6">
                            ...
                            {!userDetailsFromLocalStorage && (
                                <div>
                                    <Links href="/auth/signup" className="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700">
                                        Sign up
                                    </Links>
                                    <Links href="/auth/login" className="mt-5 flex text-indigo-600 hover:text-indigo-500 justify-center text-center text-base font-medium text-gray-500">
